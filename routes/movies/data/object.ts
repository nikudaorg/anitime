...
const moviesObject = {
  ...
  Hertz: {
    ...
    synopsis: {
      en: [
        'Hertz, an astronaut and son of a musician lost to time, meets Coco, a ghost who once dreamed of opera. A tragic collision pulls him into her drifting cosmic theatre, where together they revive the silent stage and confront the intertwined echoes of their pasts.',
      ],
      ru: [
        'Герц, астронавт и сын музыканта, исчезнувшего во времени, встречает Коко — призрака, мечтавшего стать оперной певицей. Трагическое столкновение втягивает его в её плывущий в космосе театр, где они оживляют молчаливую сцену и сталкиваются с переплетёнными эхо прошлого.',
      ],
      he: [
        'הרץ, אסטרונאוט ובנו של מוזיקאי שאבד בזמן, פוגש את קוקו — רוח שחלמה להיות זמרת אופרה. תאונה טרגית מושכת אותו לתיאטרה הצף בחלל, ושניהם מחיים את הבמה הדוממת ומתמודדים עם הדים שזורים מעברם.',
      ],
    },
    type: 'international',
  },
  ...
  'The Pangs of Mu': {
    ...
    synopsis: {
      ...
      ru: [
        'Молодой музыкант, измученный муками Музыки, мечтает взобраться на гору славы, но становится жертвой неожиданного побочного эффекта своей работы. В его голове поселяется безумная птица — и прилетела она не одна.',
      ],
      he: [
